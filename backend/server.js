...
// 4. Using safe Memory Storage configuration to bypass disk writes completely
...
const listingSchema = new mongoose.Schema(
  {
    ...
    category: String,
    condition: String,
    location: String,       // Synced with frontend form UI
    contactNumber: String,  // Synced with frontend form UI
    image: String,          // Stores absolute image URLs generated by Cloudinary
    seller: {
...
app.post(
  ...
  async (req, res) => {
    try {
      const { title, description, price, category, condition, location, contactNumber } = req.body;
      let cloudinaryUrl = "";

      // Native multi-part boundary stream buffer injection pass
      if (req.file) {
        const uploadPromise = () => {
...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      const { title, description, price, category, condition, location, contactNumber } = req.body;
      let updateFields = { title, description, price, category, condition, location, contactNumber };
